...
data class CustomTimetableLectureAddRequestBody(
    ...
    val credit: Int? = null,
    val classPlaceAndTime: List<ClassPlaceAndTimeRequestBody> = emptyList(),
...
data class TimetableLectureModifyRequestBody(
    ...
    val instructor: String? = null,
    val credit: Int? = null,
    val classPlaceAndTime: List<ClassPlaceAndTimeRequestBody>? = null,
    val remark: String? = null,
    val color: ColorSet? = null,
    val colorIndex: Int? = null,
    val isForced: Boolean = false,
        ...
        timetableLectureService
            .addCustomLecture(
                ...
                CustomTimetableLectureAddRequest(
                    ...
                    credit = body.credit,
                    classPlaceAndTime = body.classPlaceAndTime.map { parseClassPlaceAndTime(it) },
                    remark = body.remark,
                    color = body.color,
