...
(
    ...
    nickname                VARCHAR(64) COLLATE utf8mb4_0900_bin NOT NULL,
    nickname_tag            VARCHAR(4)   NOT NULL,
    local_id                VARCHAR(64) COLLATE utf8mb4_0900_bin NULL,
...
(
    ...
    sub          VARCHAR(128) COLLATE utf8mb4_0900_bin NOT NULL,
    email        VARCHAR(255) NULL,
    display_name VARCHAR(128) NULL,
    transfer_sub VARCHAR(128) COLLATE utf8mb4_0900_bin NULL,
    created_at   DATETIME(6)  NOT NULL,
    updated_at   DATETIME(6)  NOT NULL,
...
(
    ...
    avg_grade_satisfaction DOUBLE NULL,
...
(
    ...
    course_number      VARCHAR(32) COLLATE utf8mb4_0900_bin  NOT NULL,
    lecture_number     VARCHAR(16) COLLATE utf8mb4_0900_bin  NOT NULL,
    ...
    CONSTRAINT fk_lecture_course FOREIGN KEY (course_id) REFERENCES course (id) ON DELETE RESTRICT,
...
(
    ...
    created_at         DATETIME(6) NOT NULL,
    updated_at         DATETIME(6) NOT NULL,
    CONSTRAINT fk_evaluation_course FOREIGN KEY (course_id) REFERENCES course (id) ON DELETE RESTRICT,
