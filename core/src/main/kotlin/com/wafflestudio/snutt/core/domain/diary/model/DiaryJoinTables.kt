...
/**
 * 질문이 노출되는 일상 유형(daily class type) 매핑. JSON targetDailyClassTypeIdList 대신
 * FK 무결성과 조인 가능한 정규화 테이블로 대체한다.
 */
@Entity
...
/**
 * 제출에 표시된 일상 유형. JSON dailyClassTypeIdList 대신 정규화 테이블로 대체한다.
 */
@Entity
