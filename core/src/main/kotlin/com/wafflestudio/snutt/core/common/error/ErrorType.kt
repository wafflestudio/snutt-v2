...
enum class ErrorType(
    ...
    EXPIRED_ACCESS_TOKEN(HttpStatus.UNAUTHORIZED, 40102, "만료된 액세스 토큰입니다", "다시 로그인해 주세요", "로그인 만료"),
    INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, 40103, "유효하지 않은 리프레시 토큰입니다", "다시 로그인해 주세요", "로그인 만료"),
    ...
    DUPLICATE_NICKNAME(HttpStatus.CONFLICT, 40031, "nickname이 이미 사용 중입니다", "사용할 수 없는 닉네임입니다", "닉네임 변경 실패"),
